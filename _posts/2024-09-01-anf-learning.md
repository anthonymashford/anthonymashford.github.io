...
cover-img: /assets/img/anf-learn-2.jpg
...
#### Introduction to Azure NetApp Files
In this module you will discover the types of file-based workloads that are ideal for using Azure NetApp Files. Additionally, explore how the high performance and availability of Microsoft Azure NetApp Files deliver on-premises-like performance, reliability, and simplicity for cloud-based workloads.
